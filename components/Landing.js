...
export default function Landing() {
    return(
        <section className="h-svh flex items-center">
            ...
            <div className="[background-image:url(/img/hero.jpg)] absolute inset-0 bg-top bg-cover">
                <div className="absolute inset-0 backdrop-blur-[2px] bg-[#ebebeb]/40"></div>
            </div>

            {/* Content container */}
            <div id="inicio" className="absolute inset-0 max-w-screen-xl mx-auto md:w-4/6 2xl:w-4/6 md:flex">
                <div className="flex flex-col lg:flex-row items-center justify-center px-3 md:px-0">
                    <div className="text-center lg:text-left">
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5">
                            <Link legacyBehavior href='https://drive.google.com/file/d/1kxOG3hf9G2WfI23v13hjpaFI6IasyGoZ/view'>
                                <a target="_blank" className="flex gap-1 items-center py-2.5 px-5 text-sm text-[#004e98] hover:text-white font-medium bg-[#ebebeb]/50 rounded-full border transition duration-300 hover:bg-colorboton hover:scale-105 hover:shadow-[0_0_20px_3px_rgba(58,110,165,0.7)]">
